...
export default function TimerCountDown({ time }) {
  ...
  return (
      <Box display="flex" alignItems="center" justifyContent="space-between" width={"100%"} >       
        <Box  
          className="pt-[16px] pb-[8px]  bg-[#282828] w-[68px] h-[84px] md:w-[88px] md:h-[92px] rounded-[16px] border border-[#303136] text-gradient-to-r from-[#FED3CA] to-[#FFA998]" display="flex" flexDirection="column" alignItems="center"   >
