...
return (
    <Grid className="flex justify-center items-center w-full font-Oxanium text-[12px] lg:text-[14px] text-[#fafafa] leading-8	font-semibold py-[12px]  bg-[#131315]  shadow-black/5 sticky top-0 z-50" >
