...
return (
    <Grid className="w-[calc(100vw-5px)] xl:w-[1440px] flex justify-center items-center  font-Oxanium text-[12px] lg:text-[14px] text-[#fafafa] leading-8	font-semibold py-[12px] bg-[#131315] shadow-black/5 fixed top-0 z-50" >
